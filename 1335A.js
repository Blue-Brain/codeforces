...
// Конфеты и две сестры (математика)
...
// Единственная строка набора содержит одно целое число n (1≤n≤2⋅109) — количество конфет, которое у вас есть.
